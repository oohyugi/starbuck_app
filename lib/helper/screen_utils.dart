...
class ScreenUtil {
  ...
  static void init(BuildContext context,
    ...
    _screenWidth = mediaQuery.size.width-(mediaQuery.padding.left+mediaQuery.padding.right);
    _screenHeight = mediaQuery.size.height-(mediaQuery.padding.top+mediaQuery.padding.bottom);
